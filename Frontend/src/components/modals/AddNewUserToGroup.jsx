            ...
            <div className="modal-box bg-base-300">
                ...
                <form method='dialog' className='flex font-semibold items-center justify-between mt-2' >
                    ...
                    <div className='flex gap-1' >
                        ...
                        <button onClick={handleNewUserToGroup} className="rounded-full py-2 px-7 w-fit mt-2 bg-green-700 text-base-content cursor-pointer hover:bg-green-700/80" >Add Users</button>
                    </div>
                </form>
            </div>
        </dialog>
